...
export const RegisterPage: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    const passwordMatchError = validatePasswordMatch(formData.password, formData.confirm_password);
    if (passwordMatchError) newErrors.confirm_password = passwordMatchError;
